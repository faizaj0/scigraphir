...
sys.path.insert(0, f"{_ROOT}/sir4-retrieval/eval")

_spec = importlib.util.spec_from_file_location(
    "semantic_scorer", f"{_ROOT}/sir4-retrieval/eval/semantic_scorer.py")
...
def main():
    ...
    out_root = a.out or f"{_ROOT}/sir4-retrieval/results/view_norm_{a.dataset}"
