...
def main():
    ...
    queries = {x["id"]: x for x in json.load(open(f"{R}/kg-construction/data/{D}_test/raw/test.json"))}
    qf = {}
    qp = f"{R}/quartet/data.nosync/benchmark/{D.replace('sir4_', '')}_test_final/eval.json"
