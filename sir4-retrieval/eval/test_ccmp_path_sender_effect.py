...
kernels are not exercised. Run:
    python3 -m unittest discover -s sir4-retrieval/eval -p test_ccmp_path_sender_effect.py -v
"""
import ast
import contextlib
import io
...
class PathSenderTest(unittest.TestCase):
    ...
    def test_workflow_writes_results_resumes_by_hash_and_loads_strictly(self):
        source = (ROOT / "sir4-retrieval/eval/ccmp_path_sender_workflow.py").read_text()
