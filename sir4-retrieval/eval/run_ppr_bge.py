...
KG = ROOT / "kg-construction"
sys.path.insert(0, str(ROOT))
sys.path.insert(0, str(KG))

from cargo_paths import corpus_dir, emb_dir, set_dataset  # noqa: E402
from eval.cargo_operator import BGE_QI, cached_encode  # noqa: E402
...
def main() -> int:
    ...
    out_dir = Path(a.out_dir) if a.out_dir else ROOT / "sir4-retrieval" / "results" / graph_name
