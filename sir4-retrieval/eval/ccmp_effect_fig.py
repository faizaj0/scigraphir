...
gives the stratum (cross / same). Run:
    ...
    python3 eval/ccmp_effect_fig.py --dir results/qualitative/drive_scan_sir4_cs --docs ../kg-construction/data/sir4_cs_test/raw/documents.json \
        --quartet ../quartet/data.nosync/benchmark/cs_test_final/eval.json --out ../figures/fig_ccmp_effect_cs
"""
