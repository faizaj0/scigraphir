...
Run: python3 -m unittest discover -s sir4-retrieval/eval -p test_ccmp_mechanism.py -v
"""
import ast
import contextlib
import io
...
ENGINE = ROOT / "kg-construction/gfm-rag/gfmrag/models/ultra/models.py"
...
class MechanismTest(unittest.TestCase):
    ...
    def test_workflow_writes_results_resumes_by_hash_and_loads_strictly(self):
        ...
        source = (ROOT / "sir4-retrieval/eval/ccmp_mechanism_workflow.py").read_text()
