...
Each SIR-4 field ships kg-construction/data/sir4_<field>_test/raw/{documents.json, test.json}:
...
DATA_ROOT = f"{CARGO}/kg-construction/data"
FIELDS = ["cs", "biology", "physics", "matsci"]

# Sibling repos the runners import from (edit here if they move).
PROJECT_WEEK9 = os.path.expanduser("~/Desktop/Project_Week9")
