...
from cargo_paths import banner, corpus_dir, set_dataset       # noqa: E402


def mirrors(dataset: str, split: str) -> list[str]:
    """Every raw/ dir holding this split's query file.

    stage_sir4.py writes the staged corpus TWICE: once under sir4-retrieval/data
    (our copy) and once under kg-construction/data (where the pipeline reads).
...
def main() -> int:
    ...
    ap.add_argument("--dataset", default=os.environ.get("CARGO_DATASET", "tomato"))
