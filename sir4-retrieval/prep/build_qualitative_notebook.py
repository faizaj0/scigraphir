...
OVERLAY_REL = rb.OVERLAY_REL + ["sir4-retrieval/eval/pick_qualitative.py", "sir4-retrieval/eval/render_qualitative.py"]
...
for lab, p in (("queries", QUERIES), ("documents", DOCS), ("probes", PROBES),
    ...
    print(f"  ok  {lab:13} {p.replace(CARGO_ROOT, '<root>')}")
...
def main() -> int:
    ...
    out = a.out or f"{ROOT}/colab_qualitative_{a.field}.ipynb"
