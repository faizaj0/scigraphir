...
for _z in EXTRA_BUNDLES:
    ...
    zipfile.ZipFile(_z).extractall(CARGO_ROOT); print("unpacked", os.path.basename(_z))
...
def main() -> int:
    ...
    cells += [md("## 4. Multi-view scorer and component tables"), code(HELPERS), code(SCORER),
              ...
              code(VALIDATE_CELL)]
    out = a.out or f"{ROOT}/colab_routing_{a.dataset}{'' if a.graph_suffix == 'v16sc' else '_' + a.graph_suffix}.ipynb"
