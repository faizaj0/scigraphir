...
released CSVs into the corpus + query layout every pipeline script reads via cargo_paths.
...
KG_DATA = f"{CARGO}/kg-construction/data"    # where cargo_paths.corpus_dir(split) resolves
