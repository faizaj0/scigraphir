...
> `../sir4-retrieval/eval/score_sir4.py` reads for CompleteSet@k. The README text that follows
...
| 9 | Contamination audit vs TOMATO-Star | reusable from `kg-construction/experiments/researchbench/` |
...
quartet/
  ...
  build/                         construction scripts, stages 1-7
  data/                          outputs
  docs/ch4_data_collection.tex   thesis subsection
```
