#!/usr/bin/env python3
"""SIR-4 stage 3: Equivalence-Aware Inspiration Decomposition (EAID).

EAID fixes and verifies the target, constructs an inspiration decomposition,
then searches for validated alternative sets through the substitution sweep.
