"""
sciafford — extract the SMT relational frame per document / query.
...
from scigraphir_paths import add_dataset_arg, banner, corpus_dir, frames_path, set_dataset  # noqa: E402
