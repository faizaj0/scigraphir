...
Writes : retriever/tomato_star/train_selection.json
No API key needed.
"""
...
def main() -> None:
    ...
    ap.add_argument("--out", default=os.path.join(os.path.dirname(os.path.abspath(__file__)), "train_selection.json"))
