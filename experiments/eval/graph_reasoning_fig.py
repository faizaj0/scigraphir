...
def main():
    ...
    ax.set_title("(a) success against the length of the top route", fontsize=8, color=INK, loc="left")
    ...
    if deg:
        ...
        ax.set_title("(c) route weight and success against the largest sender degree on the route", fontsize=8, color=INK, loc="left")
        ...
        if xs:
            ...
            ax.set_title("(d) CCMP gate against the sender's degree", fontsize=8, color=INK, loc="left")
