...
Open `experiments/notebooks/colab_table4_openie.ipynb` in Colab, choose an A100 or L4 GPU, and run all cells. The existing Drive directory is `/content/drive/MyDrive/cargo-gfmrag`. The notebook embeds its analysis and engine overlay; no extra code upload is needed.
...
```sh
python3 experiments/prep/build_table4_notebook.py
