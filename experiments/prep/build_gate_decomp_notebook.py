...
SRC = f"{S4}/notebooks/colab_showcase_all.ipynb"
OUT = f"{S4}/notebooks/colab_ccmp_gate_decomp.ipynb"
...
'''.replace("__INTERP_B64__", b64(f"{ROOT}/retriever/gfm-rag/gfmrag/workflow/interpret_paths.py")) \
