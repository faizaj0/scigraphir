...
Both run inside the Colab notebooks after the scorer cell (section 5b / 5d); the notebooks
save the results to Drive because they are the expensive artefacts.

The directory name is historical (an early probe-seeding experiment); only these two
scripts remain.
