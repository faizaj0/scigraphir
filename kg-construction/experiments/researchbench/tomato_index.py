...
Usage:
  python experiments/researchbench/tomato_index.py --out data/researchbench/tomato_index.json
"""
import argparse
import json
import os
...
TOMATO_STAR = os.path.expanduser("~/Desktop/Project_Week9/TOMATO-Star")
...
L1_PATHS = [
    ...
    f"{BASE}/kg-construction/data/tomato_train/raw/documents.json",
]
...
def main():
    ...
    ap.add_argument("--out", default=f"{BASE}/kg-construction/data/researchbench/tomato_index.json")
    a = ap.parse_args()
