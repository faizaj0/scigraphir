...
Example:
    python kg-construction/experiments/researchbench/label_researchbench_domains.py \
      --out kg-construction/data/researchbench_test
"""
...
RB_DEFAULT = Path.home() / "Desktop" / "Project_Week9" / "ResearchBench"
OUT_DEFAULT = CARGO / "kg-construction" / "data" / "researchbench_test"
SCHEMA_VERSION = 2
