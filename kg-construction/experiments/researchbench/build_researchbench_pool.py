...
Emits, in TOMATO's raw layout so the existing construct_v2 / operator / G-reasoner pipeline
runs unchanged:
...
Usage:
  python experiments/researchbench/build_researchbench_pool.py --dry-run   # report only
  python experiments/researchbench/build_researchbench_pool.py             # write corpus
"""
import argparse
import json
import os
...
RB_DEFAULT = os.path.expanduser("~/Desktop/Project_Week9/ResearchBench")
OUT_DEFAULT = f"{BASE}/kg-construction/data/researchbench"
